...
(function () {
  function init() {
    ...
    // Ambient atmosphere is now pure CSS (a single slow light drift on
    // [data-fx] sections) — no canvas, no per-frame JS, nothing tied to
    // scroll, so it stays smooth on phones.
